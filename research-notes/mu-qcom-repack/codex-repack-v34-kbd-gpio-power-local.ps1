...
$ScratchRoot = Join-Path $WoaRoot "mu-repack-v34-kbd-gpio-power-local"
...
@'
DefinitionBlock ("", "SSDT", 2, "PIPA", "I2CV34", 0x00000001)
{
...
#     ACPI\NANO0803 and binds pipakbd.sys. I2cSerialBus 0x4C + GpioIo reset/vdd/sleep. ---
$KbdAsl = Join-Path $ScratchRoot "NanoKbdSSDT.asl"
$KbdAml = Join-Path $ScratchRoot "NanoKbdSSDT.aml"
@'
DefinitionBlock ("", "SSDT", 2, "PIPA", "NANOQ34", 0x00000002)
{
...
$Fd = Join-Path $ScratchRoot "PIPA_UEFI-touchmin-v34-kbd-gpio-power-local.fd"
$FdMap = Join-Path $ScratchRoot "PIPA_UEFI-touchmin-v34-kbd-gpio-power-local.fd.map"
...
$BootImg = Join-Path $ScratchRoot "Mu-pipa-touchmin-v34-kbd-gpio-power-local.img"
...
$FinalFd = Join-Path $OutDir "pipa_muold_touchmin_v34-kbd-gpio-power-local.fd"
$FinalImg = Join-Path $OutDir "pipa_muold_touchmin_v34-kbd-gpio-power-local.img"
