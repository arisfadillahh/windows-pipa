...
$ScratchRoot = Join-Path $WoaRoot "mu-repack-v28-gio0-cleancrs-irq635-local"
...
@'
DefinitionBlock ("", "SSDT", 2, "PIPA", "I2C2V28", 0x00000001)
{
...
$TouchText = $TouchText.Replace('DefinitionBlock ("", "SSDT", 2, "PIPA", "TCHMIN", 0x00000001)', 'DefinitionBlock ("", "SSDT", 2, "PIPA", "TCH28GP", 0x00000001)')
...
$Fd = Join-Path $ScratchRoot "PIPA_UEFI-touchmin-v28-gio0-cleancrs-irq635-local.fd"
$FdMap = Join-Path $ScratchRoot "PIPA_UEFI-touchmin-v28-gio0-cleancrs-irq635-local.fd.map"
...
$BootImg = Join-Path $ScratchRoot "Mu-pipa-touchmin-v28-gio0-cleancrs-irq635-local.img"
...
$FinalFd = Join-Path $OutDir "pipa_muold_touchmin_v28-gio0-cleancrs-irq635-local.fd"
$FinalImg = Join-Path $OutDir "pipa_muold_touchmin_v28-gio0-cleancrs-irq635-local.img"
