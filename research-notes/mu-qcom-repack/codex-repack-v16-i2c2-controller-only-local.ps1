...
$ScratchRoot = Join-Path $WoaRoot "mu-repack-v16-i2c2-controller-only-local"
...
@'
DefinitionBlock ("", "SSDT", 2, "PIPA", "I2C2TST", 0x00000001)
{
...
$Fd = Join-Path $ScratchRoot "PIPA_UEFI-touchmin-v16-i2c2-controller-only-local.fd"
$FdMap = Join-Path $ScratchRoot "PIPA_UEFI-touchmin-v16-i2c2-controller-only-local.fd.map"
...
$BootImg = Join-Path $ScratchRoot "Mu-pipa-touchmin-v16-i2c2-controller-only-local.img"
...
$FinalFd = Join-Path $OutDir "pipa_muold_touchmin_v16-i2c2-controller-only-local.fd"
$FinalImg = Join-Path $OutDir "pipa_muold_touchmin_v16-i2c2-controller-only-local.img"
