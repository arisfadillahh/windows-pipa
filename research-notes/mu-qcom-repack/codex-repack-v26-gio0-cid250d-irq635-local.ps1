...
$ScratchRoot = Join-Path $WoaRoot "mu-repack-v26-gio0-cid250d-irq635-local"
...
@'
DefinitionBlock ("", "SSDT", 2, "PIPA", "I2C2V26", 0x00000001)
{
...
# --- TouchMin SEC5 regen: ONLY change GIO0 _CID QCOMFFE3 -> QCOM250D so qcgpio8250 binds ---
$TouchAslSource = Join-Path $SourceRoot "Platforms\Xiaomi\pipaPkg\AcpiTables\TouchMinSSDT.asl"
$TouchAsl = Join-Path $ScratchRoot "TouchMinGio0Cid250dSSDT.asl"
$TouchAml = Join-Path $ScratchRoot "TouchMinGio0Cid250dSSDT.aml"
...
$origCount = ([regex]::Matches($TouchText, [regex]::Escape('Name (_CID, "QCOMFFE3")'))).Count
if ($origCount -ne 1) {
    throw "Expected exactly 1 QCOMFFE3 _CID in TouchMinSSDT.asl, found $origCount"
}
$TouchText = $TouchText.Replace('DefinitionBlock ("", "SSDT", 2, "PIPA", "TCHMIN", 0x00000001)', 'DefinitionBlock ("", "SSDT", 2, "PIPA", "TCH250D", 0x00000001)')
$TouchText = $TouchText.Replace('Name (_CID, "QCOMFFE3")', 'Name (_CID, "QCOM250D")')
...
$Fd = Join-Path $ScratchRoot "PIPA_UEFI-touchmin-v26-gio0-cid250d-irq635-local.fd"
$FdMap = Join-Path $ScratchRoot "PIPA_UEFI-touchmin-v26-gio0-cid250d-irq635-local.fd.map"
...
$BootImg = Join-Path $ScratchRoot "Mu-pipa-touchmin-v26-gio0-cid250d-irq635-local.img"
...
$FinalFd = Join-Path $OutDir "pipa_muold_touchmin_v26-gio0-cid250d-irq635-local.fd"
$FinalImg = Join-Path $OutDir "pipa_muold_touchmin_v26-gio0-cid250d-irq635-local.img"
