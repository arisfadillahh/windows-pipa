...
$ScratchRoot = Join-Path $WoaRoot "mu-repack-v24-no-gio0-qcom2511-local"
...
$I2CAsl = Join-Path $ScratchRoot "I2C2Qcom2511OnlySSDT.asl"
$I2CAml = Join-Path $ScratchRoot "I2C2Qcom2511OnlySSDT.aml"

@'
DefinitionBlock ("", "SSDT", 2, "PIPA", "I2C2Q25", 0x00000001)
{
...
$Fd = Join-Path $ScratchRoot "PIPA_UEFI-touchmin-v24-no-gio0-qcom2511-local.fd"
$FdMap = Join-Path $ScratchRoot "PIPA_UEFI-touchmin-v24-no-gio0-qcom2511-local.fd.map"
...
$BootImg = Join-Path $ScratchRoot "Mu-pipa-touchmin-v24-no-gio0-qcom2511-local.img"
...
$FinalFd = Join-Path $OutDir "pipa_muold_touchmin_v24-no-gio0-qcom2511-local.fd"
$FinalImg = Join-Path $OutDir "pipa_muold_touchmin_v24-no-gio0-qcom2511-local.img"
