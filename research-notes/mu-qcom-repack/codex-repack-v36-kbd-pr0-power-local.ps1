...
$ScratchRoot = Join-Path $WoaRoot "mu-repack-v36-kbd-pr0-power-local"
...
@'
DefinitionBlock ("", "SSDT", 2, "PIPA", "I2CV36", 0x00000001)
{
...
#     ACPI\NANO0803 and binds pipakbd.sys. I2cSerialBus 0x4C + _PR0 PowerResource GPIO power. ---
$KbdAsl = Join-Path $ScratchRoot "NanoKbdSSDT.asl"
$KbdAml = Join-Path $ScratchRoot "NanoKbdSSDT.aml"
@'
DefinitionBlock ("", "SSDT", 2, "PIPA", "NANOQ36", 0x00000004)
{
...
$Fd = Join-Path $ScratchRoot "PIPA_UEFI-touchmin-v36-kbd-pr0-power-local.fd"
$FdMap = Join-Path $ScratchRoot "PIPA_UEFI-touchmin-v36-kbd-pr0-power-local.fd.map"
...
$BootImg = Join-Path $ScratchRoot "Mu-pipa-touchmin-v36-kbd-pr0-power-local.img"
...
$FinalFd = Join-Path $OutDir "pipa_muold_touchmin_v36-kbd-pr0-power-local.fd"
$FinalImg = Join-Path $OutDir "pipa_muold_touchmin_v36-kbd-pr0-power-local.img"
