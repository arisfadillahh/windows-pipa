...
$ScratchRoot = Join-Path $WoaRoot "mu-repack-v21-gio0-cid250d-i2c2-local"
...
$BootImg = Join-Path $ScratchRoot "Mu-pipa-touchmin-v21-gio0-cid250d-i2c2-local.img"
...
$FinalFd = Join-Path $OutDir "pipa_muold_touchmin_v21-gio0-cid250d-i2c2-local.fd"
$FinalImg = Join-Path $OutDir "pipa_muold_touchmin_v21-gio0-cid250d-i2c2-local.img"
