...
$ScratchRoot = Join-Path $WoaRoot "mu-repack-v35-kbd-acpi-ps0-power-local"
...
@'
DefinitionBlock ("", "SSDT", 2, "PIPA", "I2CV35", 0x00000001)
{
...
#     ACPI\NANO0803 and binds pipakbd.sys. I2cSerialBus 0x4C + ACPI _PS0 GPIO power. ---
$KbdAsl = Join-Path $ScratchRoot "NanoKbdSSDT.asl"
$KbdAml = Join-Path $ScratchRoot "NanoKbdSSDT.aml"
@'
DefinitionBlock ("", "SSDT", 2, "PIPA", "NANOQ35", 0x00000003)
{
    ...
    Scope (\_SB.I2C2)
    {
        Device (KBD0)
        {
            ...
            {
                Return (ConcatenateResTemplate (I2CR, GPOR))
            }
        }
    }
}
...
$Fd = Join-Path $ScratchRoot "PIPA_UEFI-touchmin-v35-kbd-acpi-ps0-power-local.fd"
$FdMap = Join-Path $ScratchRoot "PIPA_UEFI-touchmin-v35-kbd-acpi-ps0-power-local.fd.map"
...
$BootImg = Join-Path $ScratchRoot "Mu-pipa-touchmin-v35-kbd-acpi-ps0-power-local.img"
...
$FinalFd = Join-Path $OutDir "pipa_muold_touchmin_v35-kbd-acpi-ps0-power-local.fd"
$FinalImg = Join-Path $OutDir "pipa_muold_touchmin_v35-kbd-acpi-ps0-power-local.img"
