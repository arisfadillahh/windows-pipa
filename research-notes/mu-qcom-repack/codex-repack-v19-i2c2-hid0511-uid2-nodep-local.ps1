...
$ScratchRoot = Join-Path $WoaRoot "mu-repack-v19-i2c2-hid0511-uid2-nodep-local"
...
$Fd = Join-Path $ScratchRoot "PIPA_UEFI-touchmin-v19-i2c2-hid0511-uid2-nodep-local.fd"
$FdMap = Join-Path $ScratchRoot "PIPA_UEFI-touchmin-v19-i2c2-hid0511-uid2-nodep-local.fd.map"
...
$BootImg = Join-Path $ScratchRoot "Mu-pipa-touchmin-v19-i2c2-hid0511-uid2-nodep-local.img"
...
$FinalFd = Join-Path $OutDir "pipa_muold_touchmin_v19-i2c2-hid0511-uid2-nodep-local.fd"
$FinalImg = Join-Path $OutDir "pipa_muold_touchmin_v19-i2c2-hid0511-uid2-nodep-local.img"
