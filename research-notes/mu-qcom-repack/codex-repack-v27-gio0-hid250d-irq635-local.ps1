...
$ScratchRoot = Join-Path $WoaRoot "mu-repack-v27-gio0-hid250d-irq635-local"
...
@'
DefinitionBlock ("", "SSDT", 2, "PIPA", "I2C2V27", 0x00000001)
{
...
$TouchAsl = Join-Path $ScratchRoot "TouchMinGio0Hid250dSSDT.asl"
$TouchAml = Join-Path $ScratchRoot "TouchMinGio0Hid250dSSDT.aml"
...
$TouchText = $TouchText.Replace('DefinitionBlock ("", "SSDT", 2, "PIPA", "TCHMIN", 0x00000001)', 'DefinitionBlock ("", "SSDT", 2, "PIPA", "TCH27GP", 0x00000001)')
...
$Fd = Join-Path $ScratchRoot "PIPA_UEFI-touchmin-v27-gio0-hid250d-irq635-local.fd"
$FdMap = Join-Path $ScratchRoot "PIPA_UEFI-touchmin-v27-gio0-hid250d-irq635-local.fd.map"
...
$BootImg = Join-Path $ScratchRoot "Mu-pipa-touchmin-v27-gio0-hid250d-irq635-local.img"
...
$FinalFd = Join-Path $OutDir "pipa_muold_touchmin_v27-gio0-hid250d-irq635-local.fd"
$FinalImg = Join-Path $OutDir "pipa_muold_touchmin_v27-gio0-hid250d-irq635-local.img"
