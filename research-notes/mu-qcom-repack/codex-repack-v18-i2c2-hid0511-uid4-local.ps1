...
$ScratchRoot = Join-Path $WoaRoot "mu-repack-v18-i2c2-hid0511-uid4-local"
...
@'
DefinitionBlock ("", "SSDT", 2, "PIPA", "I2C2UID4", 0x00000001)
{
...
$Fd = Join-Path $ScratchRoot "PIPA_UEFI-touchmin-v18-i2c2-hid0511-uid4-local.fd"
$FdMap = Join-Path $ScratchRoot "PIPA_UEFI-touchmin-v18-i2c2-hid0511-uid4-local.fd.map"
...
$BootImg = Join-Path $ScratchRoot "Mu-pipa-touchmin-v18-i2c2-hid0511-uid4-local.img"
...
$FinalFd = Join-Path $OutDir "pipa_muold_touchmin_v18-i2c2-hid0511-uid4-local.fd"
$FinalImg = Join-Path $OutDir "pipa_muold_touchmin_v18-i2c2-hid0511-uid4-local.img"
