...
$ScratchRoot = Join-Path $WoaRoot "mu-repack-v23-gio0-raw-noqupirq-i2c2-local"
...
$TouchAsl = Join-Path $ScratchRoot "TouchMinGio0RawNoQupIrqSSDT.asl"
$TouchAml = Join-Path $ScratchRoot "TouchMinGio0RawNoQupIrqSSDT.aml"
...
$TouchText = $TouchText.Replace('DefinitionBlock ("", "SSDT", 2, "PIPA", "TCHMIN", 0x00000001)', 'DefinitionBlock ("", "SSDT", 2, "PIPA", "TCHIRQ", 0x00000001)')
$TouchText = $TouchText.Replace('Name (_CID, "QCOMFFE3")', 'Name (_CID, "QCOM250D")')
$TouchText = $TouchText.Replace('0x0B, 0x01, 0x5B, 0x02, 0x00, 0x00', '0x0B, 0x01, 0xF0, 0x00, 0x00, 0x00')
$TouchText = $TouchText.Replace('0x09, 0x01, 0x59, 0x02, 0x00, 0x00', '0x09, 0x01, 0xF0, 0x00, 0x00, 0x00')
...
$BootImg = Join-Path $ScratchRoot "Mu-pipa-touchmin-v23-gio0-raw-noqupirq-i2c2-local.img"
...
$FinalFd = Join-Path $OutDir "pipa_muold_touchmin_v23-gio0-raw-noqupirq-i2c2-local.fd"
$FinalImg = Join-Path $OutDir "pipa_muold_touchmin_v23-gio0-raw-noqupirq-i2c2-local.img"
