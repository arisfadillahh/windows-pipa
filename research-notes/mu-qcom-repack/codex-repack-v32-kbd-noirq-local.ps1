...
$ScratchRoot = Join-Path $WoaRoot "mu-repack-v32-kbd-noirq-local"
...
@'
DefinitionBlock ("", "SSDT", 2, "PIPA", "I2C2V32", 0x00000001)
{
...
$TouchText = $TouchText.Replace('DefinitionBlock ("", "SSDT", 2, "PIPA", "TCHMIN", 0x00000001)', 'DefinitionBlock ("", "SSDT", 2, "PIPA", "TCH32KB", 0x00000001)')
...
#     ACPI\NANO0803 and binds pipakbd.sys. I2cSerialBus 0x4C + GpioInt GPIO100. ---
$KbdAsl = Join-Path $ScratchRoot "NanoKbdSSDT.asl"
$KbdAml = Join-Path $ScratchRoot "NanoKbdSSDT.aml"
@'
DefinitionBlock ("", "SSDT", 2, "PIPA", "NANOKB2", 0x00000001)
{
...
$Fd = Join-Path $ScratchRoot "PIPA_UEFI-touchmin-v32-kbd-noirq-local.fd"
$FdMap = Join-Path $ScratchRoot "PIPA_UEFI-touchmin-v32-kbd-noirq-local.fd.map"
...
$BootImg = Join-Path $ScratchRoot "Mu-pipa-touchmin-v32-kbd-noirq-local.img"
...
$FinalFd = Join-Path $OutDir "pipa_muold_touchmin_v32-kbd-noirq-local.fd"
$FinalImg = Join-Path $OutDir "pipa_muold_touchmin_v32-kbd-noirq-local.img"
