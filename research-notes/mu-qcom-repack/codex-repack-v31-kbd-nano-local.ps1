...
$ScratchRoot = Join-Path $WoaRoot "mu-repack-v31-kbd-nano-local"
...
@'
DefinitionBlock ("", "SSDT", 2, "PIPA", "I2C2V31", 0x00000001)
{
...
$TouchText = $TouchText.Replace('DefinitionBlock ("", "SSDT", 2, "PIPA", "TCHMIN", 0x00000001)', 'DefinitionBlock ("", "SSDT", 2, "PIPA", "TCH31KB", 0x00000001)')
...
$Fd = Join-Path $ScratchRoot "PIPA_UEFI-touchmin-v31-kbd-nano-local.fd"
$FdMap = Join-Path $ScratchRoot "PIPA_UEFI-touchmin-v31-kbd-nano-local.fd.map"
...
$BootImg = Join-Path $ScratchRoot "Mu-pipa-touchmin-v31-kbd-nano-local.img"
...
$FinalFd = Join-Path $OutDir "pipa_muold_touchmin_v31-kbd-nano-local.fd"
$FinalImg = Join-Path $OutDir "pipa_muold_touchmin_v31-kbd-nano-local.img"
