...
$ScratchRoot = Join-Path $WoaRoot "mu-repack-v25-i2c2-irq635-local"
...
@'
DefinitionBlock ("", "SSDT", 2, "PIPA", "I2C2V25", 0x00000001)
{
...
$Fd = Join-Path $ScratchRoot "PIPA_UEFI-touchmin-v25-i2c2-irq635-local.fd"
$FdMap = Join-Path $ScratchRoot "PIPA_UEFI-touchmin-v25-i2c2-irq635-local.fd.map"
...
$BootImg = Join-Path $ScratchRoot "Mu-pipa-touchmin-v25-i2c2-irq635-local.img"
...
$FinalFd = Join-Path $OutDir "pipa_muold_touchmin_v25-i2c2-irq635-local.fd"
$FinalImg = Join-Path $OutDir "pipa_muold_touchmin_v25-i2c2-irq635-local.img"
