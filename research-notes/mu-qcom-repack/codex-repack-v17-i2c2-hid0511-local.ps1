...
$ScratchRoot = Join-Path $WoaRoot "mu-repack-v17-i2c2-hid0511-local"
...
@'
DefinitionBlock ("", "SSDT", 2, "PIPA", "I2C2HID", 0x00000001)
{
...
$Fd = Join-Path $ScratchRoot "PIPA_UEFI-touchmin-v17-i2c2-hid0511-local.fd"
$FdMap = Join-Path $ScratchRoot "PIPA_UEFI-touchmin-v17-i2c2-hid0511-local.fd.map"
...
$BootImg = Join-Path $ScratchRoot "Mu-pipa-touchmin-v17-i2c2-hid0511-local.img"
...
$FinalFd = Join-Path $OutDir "pipa_muold_touchmin_v17-i2c2-hid0511-local.fd"
$FinalImg = Join-Path $OutDir "pipa_muold_touchmin_v17-i2c2-hid0511-local.img"
