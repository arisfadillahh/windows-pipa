...
$OutDir = "C:\woa\v24-qcom2511-nogio-dump"
...
try {
    "Pipa v24 no-GIO0 pure-QCOM2511/qci2c dump" | Set-Content -LiteralPath $Result -Encoding UTF8
    Add-Line "started: $(Get-Date -Format o)"
    Add-Line "user: $env:USERDOMAIN\$env:USERNAME"
    Add-Line "image expected: pipa_muold_touchmin_v24-no-gio0-qcom2511-local"
